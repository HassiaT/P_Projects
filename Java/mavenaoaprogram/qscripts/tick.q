...
if[system"t";
 ...
 t insert x;if[l;l enlist (`upd;t;x);j+:1;];.u.flush[.u.currentdate];}];
...
if[not system"t";system"t 1000";
 ...
 f:key flip value t;pub[t;$[0>type first x;enlist f!x;flip f!x]];if[l;l enlist (`upd;t;x);i+:1];;.u.flush[.u.currentdate]}];
